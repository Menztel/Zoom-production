...
include('../includes/bdd.php');
   //Vérification image : fichier uploadé est une image et ne dépasse pas 1Mo.
    ...
    if(isset($_POST['addForm-button']) && isset($_POST['project-title']) && isset($$_POST['page-name-project']) && isset($_FILES['project-image'])) {
    ...
    {
        header('location: ../admin_page.php?message=Tous les champs ne sont pas remplis&type=error');
        exit;
    }
